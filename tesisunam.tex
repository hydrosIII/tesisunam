%% esta es una macro en latex para la tesis de la UNAM, expecializada en las humanides y las ciencias sociales
%%% ahora para el formato esis 23cmmx 17 cm aunque se puede cambiar facilmente a tamaño carta.
%% esta basada en la clase mamoir, se puede consultar la documentación de esta clase en la CTAN.
%% la siguiente macro estpá hecha para ser compilada con xelatex.


%%doble cara, esto se puede cambiar facilmente, solo agrear onwside
%% los capítulo abres siempre por la derecha.
%% tamaño de letra 12
...
\usepackage{polyglossia} %% manejo de - en las palabras al cortar linea y otras características del idioma espñaol, define también otros idiomas
\setdefaultlanguage{spanish}

%%% esto es para que el primer parrafo después de un título no aparexca con sangría, aunque eso es sólo en la traición inglesa,
...
%% el paquete hyperref para mas refencias en el texto, además los ULR y referencias y notas al pie se vuelven "clicables".
%%% Tambien genera los metadatos del PDF, importante para los gestores de bibliografía como zotero o endnote o Mendeley cuando indexen tu tesis, 
\usepackage[xetex,
            pdfauthor={Autor},
            pdftitle={Título},
...
%%%% de humanides y ciencias sociales. usa biblatex y un montón de pargámetros para que salgan como deben quedar.
...
%% cosas de atras, generalmente no son necesarias en la tesis.
\backmatter
